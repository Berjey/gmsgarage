...
@php
    ...
    $kvkkCustomers  = \App\Models\Customer::where('kvkk_consent', true)->count();
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
    <div class="bg-white rounded-xl p-6 border-2 border-primary-100 shadow-sm group">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-gray-600 text-sm font-medium mb-1">Toplam Müşteri</p>
    ...
    <div class="bg-white rounded-xl p-6 border-2 border-gray-100 shadow-sm hover:shadow-lg hover:border-green-300 transition-all group">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-gray-600 text-sm font-medium mb-1">KVKK Onaylı</p>
                <p class="text-3xl font-bold text-gray-900 group-hover:text-green-600 transition-colors">{{ $kvkkCustomers }}</p>
            </div>
    ...
    <div class="bg-white rounded-xl p-6 border-2 border-gray-100 shadow-sm hover:shadow-lg hover:border-blue-300 transition-all group">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-gray-600 text-sm font-medium mb-1">Bugün Eklenen</p>
                <p class="text-3xl font-bold text-gray-900 group-hover:text-blue-600 transition-colors">{{ $todayCustomers }}</p>
            </div>
    ...
    <div class="p-6 border-b border-gray-200">
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-2">Toplam <span class="font-bold text-primary-600">{{ $totalCustomers }}</span> müşteri kayıtlı</p>
            </div>
    ...
    <div class="overflow-x-auto">
        ...
        <div class="px-6 py-4 border-t border-gray-200 bg-gray-50/50 flex items-center justify-between">
            <p class="text-sm text-gray-500">
                {{ $customers->firstItem() }}-{{ $customers->lastItem() }} arası gösteriliyor
                (toplam {{ $customers->total() }} müşteri)
            </p>
            {{ $customers->links() }}
        </div>
        @endif
