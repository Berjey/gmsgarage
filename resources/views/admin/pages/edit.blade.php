...
<div class="bg-white dark:bg-[#252525] rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm p-6">
    <h2 class="text-xl font-bold text-gray-900 dark:text-gray-100 mb-6">Sayfa Düzenle</h2>
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <textarea name="content" rows="10"
                          class="w-full px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-[#1e1e1e] text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-primary-500">{{ old('content', $page->content) }}</textarea>
            ...
            <div>
                ...
                <textarea name="meta_description" rows="3"
                          class="w-full px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-[#1e1e1e] text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-primary-500">{{ old('meta_description', $page->meta_description) }}</textarea>
            </div>
