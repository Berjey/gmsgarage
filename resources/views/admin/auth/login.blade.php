...
<div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
        <div>
            <img class="mx-auto h-16 w-auto" src="{{ asset('images/light-mode-logo.png') }}" alt="GMSGARAGE">
            <h2 class="mt-6 text-center text-3xl font-extrabold text-gray-900">Admin Paneline Giriş</h2>
        ...
        <form class="mt-8 space-y-6" action="{{ route('admin.login.post') }}" method="POST">
            ...
            <div>
                <button type="submit" class="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-bold rounded-lg text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-all shadow-lg shadow-primary-500/30">
