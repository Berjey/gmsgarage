    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                ...
                <div class="p-8 space-y-6">
                    {{-- Araç SVG — ortalanmış, sabit boyut --}}
                    <div class="max-w-[160px] mx-auto bg-gray-50 rounded-xl p-3 border border-gray-100">
                    ...
                    <div class="flex items-center justify-center gap-5 flex-wrap">
                        <span class="flex items-center gap-1.5 text-xs text-gray-500 font-medium"><span class="w-2.5 h-2.5 rounded-full bg-white border-2 border-gray-300 inline-block"></span>Orijinal</span>
                        <span class="flex items-center gap-1.5 text-xs text-gray-500 font-medium"><span class="w-2.5 h-2.5 rounded-full bg-blue-400 inline-block"></span>Boyalı</span>
                        <span class="flex items-center gap-1.5 text-xs text-gray-500 font-medium"><span class="w-2.5 h-2.5 rounded-full bg-yellow-400 inline-block"></span>Lokal Boyalı</span>
                        <span class="flex items-center gap-1.5 text-xs text-gray-500 font-medium"><span class="w-2.5 h-2.5 rounded-full bg-red-500 inline-block"></span>Değişmiş</span>
                    </div>

                    {{-- Parça Listesi: 2 kolonlu, temiz satır tasarımı --}}
                    <div class="grid grid-cols-2 gap-x-8 gap-y-0 border-t border-gray-50 pt-4">
                        ...
                        <div class="flex items-center justify-between py-2.5 border-b border-gray-50">
                            <span class="text-xs text-gray-400 font-medium truncate mr-3">{{ $partLabels[$partKey] ?? $partKey }}</span>
                            <span class="text-xs font-bold px-2.5 py-0.5 rounded-full flex-shrink-0 {{ $c['bg'] }} {{ $c['text'] }}">{{ $c['label'] }}</span>
                        </div>
                        @endforeach
                    </div>
                </div>
