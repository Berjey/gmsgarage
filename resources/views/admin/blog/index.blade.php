...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
    <a href="{{ route('admin.blog.index') }}" class="bg-white rounded-xl p-5 border-2 border-primary-100 shadow-sm hover:border-primary-300 transition-all cursor-pointer group">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Toplam Yazı</p>
    ...
    <a href="{{ route('admin.blog.index', ['status' => 'published']) }}" class="bg-white rounded-xl p-5 border-2 border-gray-100 shadow-sm hover:border-green-300 transition-all cursor-pointer group">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Yayında</p>
    ...
    <a href="{{ route('admin.blog.index', ['status' => 'featured']) }}" class="bg-white rounded-xl p-5 border-2 border-gray-100 shadow-sm hover:border-yellow-300 transition-all cursor-pointer group">
        <div class="flex items-center justify-between">
            <div>
    ...
    <a href="{{ route('admin.blog.index', ['status' => 'draft']) }}" class="bg-white rounded-xl p-5 border-2 border-gray-100 shadow-sm hover:border-gray-300 transition-all cursor-pointer group">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Taslak</p>
            ...
            @if($posts->count() > 0)
                <table class="w-full table-fixed">
                    ...
                    <thead class="bg-gray-50 border-b border-gray-200">
                        <tr>
                            <th class="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Başlık / Açıklama</th>
                            <th class="px-6 py-3 text-center text-xs font-semibold text-gray-600 uppercase tracking-wider">Kategori</th>
                            <th class="px-6 py-3 text-center text-xs font-semibold text-gray-600 uppercase tracking-wider">İstatistik</th>
                            <th class="px-6 py-3 text-center text-xs font-semibold text-gray-600 uppercase tracking-wider">Durum</th>
                            <th class="px-6 py-3 text-center text-xs font-semibold text-gray-600 uppercase tracking-wider">Tarih</th>
                            ...
                            <td class="px-4 py-5 text-right" onclick="event.stopPropagation()">
                                <div class="flex items-center justify-end gap-1.5">
                                    <button type="button"
                                            ...
                                            class="p-1.5 rounded-lg transition-all shadow-sm {{ $post->is_featured ? 'text-amber-500 bg-amber-50 hover:bg-amber-100' : 'text-gray-400 bg-gray-50 hover:bg-amber-50 hover:text-amber-500' }}"
                                    ...
                                    <form action="{{ route('admin.blog.destroy', $post->id) }}" method="POST" class="inline-block"
                                        ...
                                        @method('DELETE')
                                        <button type="submit"
                                                class="p-1.5 text-red-600 bg-red-50 rounded-lg hover:bg-red-600 hover:text-white transition-all shadow-sm"
                                                title="Sil">
