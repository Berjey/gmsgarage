            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div class="bg-white dark:bg-[#252525] rounded-xl shadow-lg dark:shadow-xl dark:border dark:border-gray-800 p-8 transition-colors duration-200">
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-6">
                        {!! nl2br(e($contactSettings['form_description'] ?? 'Sorularınız, önerileriniz veya destek talepleriniz için aşağıdaki formu doldurun. Mesajınız info@gmsgarage.com adresine gönderilecektir.')) !!}
                    </p>
                ...
                <div class="space-y-6">
                    <div class="bg-white dark:bg-[#252525] rounded-xl shadow-lg dark:shadow-xl dark:border dark:border-gray-800 p-8 transition-colors duration-200">
                        ...
                        <div class="space-y-4">
                            ...
                            <a href="tel:{{ preg_replace('/[^0-9+]/', '', $contactSettings['phone']) }}" class="flex items-center space-x-4 p-4 bg-white dark:bg-[#2a2a2a] border-2 border-gray-200 dark:border-gray-700 rounded-xl hover:border-primary-600 dark:hover:border-primary-500 hover:bg-primary-50 dark:hover:bg-primary-900/20 transition-all duration-300 group cursor-pointer">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-primary-600 dark:text-white font-medium group-hover:text-primary-700 dark:group-hover:text-gray-200 transition-colors">{{ $contactSettings['phone'] }}</p>
                                </div>
                            ...
                            <!-- E-posta -->
                            <a href="mailto:{{ $contactSettings['email'] }}" class="flex items-center space-x-4 p-4 bg-white dark:bg-[#2a2a2a] border-2 border-gray-200 dark:border-gray-700 rounded-xl hover:border-primary-600 dark:hover:border-primary-500 hover:bg-primary-50 dark:hover:bg-primary-900/20 transition-all duration-300 group cursor-pointer">
                                <div class="bg-primary-100 dark:bg-primary-900/30 p-3 rounded-lg group-hover:bg-primary-200 dark:group-hover:bg-primary-900/50 transition-colors">
                                    <svg class="w-6 h-6 text-primary-600 dark:text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-primary-600 dark:text-white font-medium group-hover:text-primary-700 dark:group-hover:text-gray-200 transition-colors">{{ $contactSettings['email'] }}</p>
                                </div>
                                <svg class="w-5 h-5 text-gray-400 dark:text-gray-500 group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                                </svg>
                            ...
                            <!-- WhatsApp -->
                            @if($contactSettings['whatsapp'] ?? null)
                            <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $contactSettings['whatsapp']) }}" target="_blank" class="flex items-center space-x-4 p-4 bg-white dark:bg-[#2a2a2a] border-2 border-gray-200 dark:border-gray-700 rounded-xl hover:border-green-500 dark:hover:border-green-500 hover:bg-green-50 dark:hover:bg-green-900/20 transition-all duration-300 group cursor-pointer">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-green-600 dark:text-green-400 font-medium group-hover:text-green-700 dark:group-hover:text-green-300 transition-colors">{{ $contactSettings['whatsapp'] }}</p>
                                </div>
                            ...
                            <div class="flex items-center space-x-4 p-4 bg-white dark:bg-[#2a2a2a] border-2 border-gray-200 dark:border-gray-700 rounded-xl">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-gray-700 dark:text-gray-300">{{ $contactSettings['address'] }}</p>
                                </div>
                            </div>
                            @endif
                        </div>
                    ...
                    <!-- Google Maps -->
                    @if($contactSettings['google_maps_embed'] ?? null)
