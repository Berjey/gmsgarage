        ...
        <div class="container-custom">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div class="space-y-6">
                    <div class="bg-white dark:bg-[#252525] rounded-xl shadow-lg dark:shadow-xl dark:border dark:border-gray-800 p-8 transition-colors duration-200">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    <h3 class="font-semibold text-gray-900 dark:text-gray-100 mb-1">Telefon</h3>
                                    <a href="tel:+905551234567" class="text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 transition-colors">0555 123 45 67</a>
                                </div>
                            </div>
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    <h3 class="font-semibold text-gray-900 dark:text-gray-100 mb-1">E-posta</h3>
                                    <a href="mailto:info@gmsgarage.com" class="text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 transition-colors">info@gmsgarage.com</a>
                                </div>
                            </div>
                            <div class="flex items-start space-x-4">
                                <div class="bg-primary-100 dark:bg-primary-900/30 p-3 rounded-lg">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-700 dark:text-gray-300">İstanbul, Türkiye</p>
                                </div>
                            </div>
                            <div class="flex items-start space-x-4">
                                <div class="bg-primary-100 dark:bg-primary-900/30 p-3 rounded-lg">
                                ...
                                <div>
                                    <h3 class="font-semibold text-gray-900 dark:text-gray-100 mb-1">WhatsApp</h3>
                                    <a href="https://wa.me/905551234567" target="_blank" class="text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 transition-colors">0555 123 45 67</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Google Maps -->
                    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg dark:shadow-xl dark:border dark:border-gray-700 overflow-hidden transition-colors duration-200">
                        <iframe 
