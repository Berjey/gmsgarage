                ...
                <div class="space-y-6">
                    <div class="bg-white dark:bg-[#252525] rounded-xl shadow-lg dark:shadow-xl dark:border dark:border-gray-800 p-8 transition-colors duration-200">
                        ...
                        <div class="space-y-4">
                            ...
                            @endphp
                            <a href="https://wa.me/{{ $waNumber }}" target="_blank" class="flex items-center space-x-4 p-4 bg-white dark:bg-[#2a2a2a] border-2 border-gray-200 dark:border-gray-700 rounded-xl hover:border-green-500 dark:hover:border-green-500 hover:bg-green-50 dark:hover:bg-green-900/20 transition-all duration-300 group cursor-pointer">
