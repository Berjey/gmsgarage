...
<section class="section-padding bg-white">
    <div class="container-custom max-w-4xl">
        <div class="mb-8">
            <h1 class="text-4xl md:text-5xl font-bold mb-4 text-gray-900">Gizlilik Politikası</h1>
            <p class="text-gray-600 text-lg">Kişisel verilerinizin korunması bizim için önemlidir.</p>
        </div>

        <div class="prose prose-lg max-w-none">
            <div class="space-y-8">
                <section>
                    <h2 class="text-2xl font-bold mb-4 text-gray-900">Gizlilik Taahhüdümüz</h2>
                ...
                <section>
                    <h2 class="text-2xl font-bold mb-4 text-gray-900">Toplanan Bilgiler</h2>
                ...
                <section>
                    <h2 class="text-2xl font-bold mb-4 text-gray-900">Bilgilerin Kullanımı</h2>
                    <p class="text-gray-700 leading-relaxed">
                ...
                <section>
                    <h2 class="text-2xl font-bold mb-4 text-gray-900">Güvenlik</h2>
                    <p class="text-gray-700 leading-relaxed">
                ...
                <section>
                    <h2 class="text-2xl font-bold mb-4 text-gray-900">İletişim</h2>
                    <p class="text-gray-700 leading-relaxed">
                        Gizlilik politikamız hakkında sorularınız için: <a href="mailto:info@gmsgarage.com" class="text-primary-600 hover:underline">info@gmsgarage.com</a>
                    </p>
                </section>
            </div>
        </div>
