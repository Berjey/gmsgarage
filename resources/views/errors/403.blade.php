...
@section('description', 'Bu sayfaya erişim yetkiniz bulunmamaktadır.')
...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-[#1a1a1a] dark:to-[#222] flex items-center justify-center p-4">
    <div class="max-w-2xl w-full">
        <div class="bg-white dark:bg-[#1e1e1e] rounded-2xl shadow-2xl p-8 md:p-12 text-center">
            ...
            <!-- Error Code -->
            <h1 class="text-8xl font-black text-gray-200 dark:text-gray-700 mb-4">403</h1>

            <!-- Title -->
            <h2 class="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-4">Yetkisiz Erişim</h2>
            ...
            <!-- User Role Info -->
            @auth
            <div class="bg-gray-50 dark:bg-gray-800 rounded-xl p-4 mb-8 inline-block">
                <p class="text-sm text-gray-600 dark:text-gray-300">
                    ...
                    <span class="ml-2 px-3 py-1 rounded-full text-xs font-bold
                        ...
                        {{ auth()->user()->role_name ?? auth()->user()->role }}
                    </span>
                </p>
            </div>
            @endauth
