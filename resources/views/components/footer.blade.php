        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div>
                ...
                <ul class="space-y-4 mb-6">
                    ...
                    <li class="flex items-start space-x-3">
                        ...
                        <div>
                            ...
                            <span class="text-white font-semibold">{{ $settings['contact_address'] ?? 'Görsel Mah. Kağıthane Cad. No: 26 /1A KAĞITHANE/İSTANBUL' }}</span>
                        </div>
                    </li>
                </ul>
                ...
                <div class="flex space-x-3">
                    ...
                    <a href="{{ $settings['social_instagram'] }}" target="_blank" rel="noopener noreferrer" class="w-10 h-10 bg-primary-600 rounded-full flex items-center justify-center text-white hover:bg-primary-700 transition-all duration-300 hover:scale-110">
                    ...
                    <a href="{{ $settings['social_youtube'] }}" target="_blank" rel="noopener noreferrer" class="w-10 h-10 bg-primary-600 rounded-full flex items-center justify-center text-white hover:bg-primary-700 transition-all duration-300 hover:scale-110">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ $settings['social_twitter'] }}" target="_blank" rel="noopener noreferrer" class="w-10 h-10 bg-primary-600 rounded-full flex items-center justify-center text-white hover:bg-primary-700 transition-all duration-300 hover:scale-110">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ $settings['social_facebook'] }}" target="_blank" rel="noopener noreferrer" class="w-10 h-10 bg-primary-600 rounded-full flex items-center justify-center text-white hover:bg-primary-700 transition-all duration-300 hover:scale-110">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ $settings['social_linkedin'] }}" target="_blank" rel="noopener noreferrer" class="w-10 h-10 bg-primary-600 rounded-full flex items-center justify-center text-white hover:bg-primary-700 transition-all duration-300 hover:scale-110">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    @if(is_array($footerLinks) && count($footerLinks) > 0)
                        @foreach($footerLinks as $index => $link)
                            @if(!empty($link['label']) && !empty($link['url']))
                                ...
                                @endif
                                <a href="{{ Str::startsWith($link['url'], 'http') ? $link['url'] : '/kurumsal/' . $link['url'] }}" class="text-gray-400 hover:text-white transition-colors">{{ $link['label'] }}</a>
                            @endif
                        @endforeach
                    @else
