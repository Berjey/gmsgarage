...
<div class="card-vehicle group">
    <a href="{{ route('vehicles.show', $vehicle->slug) }}" class="block">
        <!-- Görsel -->
        <div class="relative h-56 bg-gray-100 overflow-hidden rounded-t-2xl">
        ...
        <div class="p-6">
            ...
            <div class="mb-3">
                ...
                <div class="flex items-center justify-between">
                    ...
                    @if($vehicle->created_at)
                        <span class="text-xs text-gray-400">{{ $vehicle->created_at->format('d.m.Y') }}</span>
                    @endif
                </div>
            </div>
            ...
            <div class="flex gap-2.5">
                <a href="{{ route('vehicles.show', $vehicle->slug) }}" 
                   class="flex-1 btn btn-primary text-sm py-3 whitespace-nowrap text-center">
                    Detayları Gör
                </a>
                @if($vehicle->sahibinden_url)
                    <a href="{{ $vehicle->sahibinden_url }}" 
                       target="_blank"
                       class="flex-1 px-4 py-3 border-2 border-primary-600 text-primary-600 hover:bg-primary-600 hover:text-white rounded-xl font-semibold transition-all duration-300 text-sm text-center whitespace-nowrap flex items-center justify-center gap-1.5">
